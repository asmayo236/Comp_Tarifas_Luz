...
export default function PotenciaInputs({ tarifa, onChange }) {
  ...
  return (
    <div className="mb-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <NumInput label="P1 (Punta)" value={tarifa.potencia_kw.p1} onChange={(v) => update('potencia_kw.p1', v)} suffix="kW" step={0.1} />
        <NumInput label="P2 (Valle)" value={tarifa.potencia_kw.p2} onChange={(v) => update('potencia_kw.p2', v)} suffix="kW" step={0.1} />
      </div>
      <div className="grid grid-cols-2 gap-3 mt-2">
        <NumInput label="Precio P1" value={tarifa.precios_potencia.p1} onChange={(v) => update('precios_potencia.p1', v)} suffix={UNIDAD_LABELS[tarifa.unidad_potencia]} step={0.01} />
        <NumInput label="Precio P2" value={tarifa.precios_potencia.p2} onChange={(v) => update('precios_potencia.p2', v)} suffix={UNIDAD_LABELS[tarifa.unidad_potencia]} step={0.01} />
      </div>
    </div>
  );
}
